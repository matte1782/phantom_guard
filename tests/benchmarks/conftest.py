...
def sample_packages() -> list[str]:
    ...
    suspicious = [
        "flask-gpt", "django-ai", "react-chatgpt", "numpy-helper",
        "pandas-wrapper", "easy-requests", "simple-flask", "auto-django",
        "flask-gpt-helper", "django-ai-utils", "fastapi-openai-client",
        "requests-llm-wrapper", "numpy-ml-helper", "pandas-ai-utils",
        "easy-numpy", "simple-pandas", "auto-pytest", "py-gpt-helper",
        "flask-chatbot", "django-llm", "react-ai-helper", "vue-gpt",
        "express-ai", "lodash-helper", "axios-wrapper", "moment-utils",
        "typescript-helper", "webpack-ai", "babel-gpt", "eslint-helper",
    ]

    # Typosquat candidates (20)
    typosquats = [
        "reqeusts", "flak", "djagno", "numppy", "padas",
        "requets", "djnago", "flaask", "panads", "npumy",
        "reuqests", "flasks", "djangoo", "numpty", "pandsa",
        "requst", "flanks", "djang", "nympy", "pnadas",
    ]
